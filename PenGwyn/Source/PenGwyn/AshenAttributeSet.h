...
UCLASS()
class PENGWYN_API UAshenAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	ATTRIBUTE_ACCESSORS(UAshenAttributeSet, Mana);
	...
	ATTRIBUTE_ACCESSORS(UAshenAttributeSet, Vigor);
	...
	ATTRIBUTE_ACCESSORS(UAshenAttributeSet, Mind);
	...
	ATTRIBUTE_ACCESSORS(UAshenAttributeSet, Endurance);
	...
	ATTRIBUTE_ACCESSORS(UAshenAttributeSet, Strength);
	...
	ATTRIBUTE_ACCESSORS(UAshenAttributeSet, Dexterity);
	...
	ATTRIBUTE_ACCESSORS(UAshenAttributeSet, Intelligence);
	...
	ATTRIBUTE_ACCESSORS(UAshenAttributeSet, Faith);
	...
	ATTRIBUTE_ACCESSORS(UAshenAttributeSet, Luck);
